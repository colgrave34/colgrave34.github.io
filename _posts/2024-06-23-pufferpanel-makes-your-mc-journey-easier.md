...
I rember a few month back, friends suddenly wanna play some Minecraft, but the price of MC server hosting is not kind.

发几张图大家感受一下。
I'll post some photos for the pricing...

Minecraft Realms 是 MC 官方的服务器租赁，Java 版本每个月要 7.99 刀。。。
Minecraft Realms is the offical server hosting service, For Java version is $7.99 per month...
...
Bisect and Apex are both two companies that advertise pretty aggressively and with 4 GB of memory is around $10 per month.
...
For a few student still in college, pocket money just enough for food and rent. Renting a server maybe just for 2 or 3 month, its pretty unnecessary.
...
While looking for a web interface for the server, I find [PufferPanel](https://www.pufferpanel.com/), which is an open source game server control panel. In my opion is the most clear, easy to use
