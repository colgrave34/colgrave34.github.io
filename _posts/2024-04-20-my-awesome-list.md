...
### [uBlock Lite](https://github.com/uBlockOrigin/uBOL-home)
Google have forces [Manifest V3](https://developer.chrome.com/docs/extensions/develop/migrate/what-is-mv3) on all Chromium based browsers. uBlock Lite is a permission-less content blocker based on the MV3 API. It's not as strong as uBlock Origin, but it's better than nothing.
